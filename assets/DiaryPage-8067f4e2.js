import{s as n,j as t,x as Q,y as X,E as Z,z as A,A as ee,B as te,C as w,P as ne,r as l,b as P,o as re,D as ie,G as oe,H as ae,h as G,I as se,N as de,a as ce,J as le}from"./index-bb739d8f.js";import{t as N,R as pe,i as me,b as O,c as k,l as _,d as H,s as U}from"./calculateTotalIngridients-cd371197.js";import{s as he}from"./statisticSelectors-3f1c7996.js";import{B as xe}from"./index-b9618b4d.js";let M=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((r,o)=>(o&=63,o<36?r+=o.toString(36):o<62?r+=(o-26).toString(36).toUpperCase():o>62?r+="-":r+="_",r),"");const ue=n.div`
  display: flex;
  row-gap: 12px;
  column-gap: 20px;
  flex-wrap: wrap;
...
`,v=({item:e,index:r,img:o,mealType:s})=>{const h=P(),[m,x]=l.useState(!1),[p,u]=l.useState(!1),{carbohidrates:c,protein:d,fat:a,dish:i,showButton:g}=e,$=()=>{x(!m)},y=()=>{u(!p)},W=async()=>{console.log(e._id,s),e&&e._id&&(await h(se({foodId:e._id,foodIntakeName:s})),await h(G(N)))};return t.jsx(t.Fragment,{children:g?t.jsxs(V,{children:[t.jsx(Y,{children:r+1}),t.jsx(Re,{onClick:$,children:"+ Record your meal"}),m&&t.jsx(pe,{onClose:$,image:o,mealType:s})]}):t.jsxs(V,{children:[t.jsx(Y,{children:r+1}),t.jsxs(Be,{children:[t.jsx(Ce,{children:i}),i&&t.jsxs(De,{children:[t.jsxs(Ee,{type:"button",onClick:y,children:[t.jsx(Te,{src:Fe,alt:"Edit"}),"Edit"]}),t.jsx(We,{type:"button",onClick:W,children:t.jsx("img",{src:me,alt:"Trash"})})]}),t.jsxs(Pe,{children:[t.jsxs(R,{children:[t.jsx("span",{children:"Carb."}),c]}),t.jsxs(Ge,{children:[t.jsx("span",{children:"Prot."}),d]}),t.jsxs(Ne,{children:[t.jsx("span",{children:"Fat."}),a]})]})]}),p&&t.jsx(J,{onClose:y,item:e,mealType:s})]})})},S=(e,r)=>e.length<=3?[...e,...Array(1).fill({mealType:r,showButton:!0}),...Array(3-e.length).fill({})]:[...e,...Array(1).fill({mealType:r,showButton:!0})],Ae=n.main`

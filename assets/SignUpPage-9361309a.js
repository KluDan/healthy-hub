import{s as d,B as C,D as I,G as b,j as t,R as N,r as y,b as q,a as E,T as F,U as P,V as W,L as D,X as o,Y as _,Z as R,$ as V,a0 as H,a1 as Y,a2 as U,a3 as z,a4 as O,a5 as Q,a6 as X,a7 as Z}from"./index-45c72abe.js";import{s as A}from"./Buttons.styled-f63a8a19.js";import{u as J}from"./useAuthResetError-e09ef727.js";const K=d.div`
  display: flex;
...
`,le=({name:e,value:a,onChange:r,onBlur:i,checked:n,label:c})=>t.jsx(t.Fragment,{children:t.jsxs(ne,{children:[t.jsx(ce,{type:"radio",name:e,value:a,onChange:r,onBlur:i,checked:n}),c]})}),S=(e,a,r,i=!1)=>t.jsx(ee,{row:i,children:a.map((n,c)=>t.jsx(le,{name:e,value:n.toLowerCase(),onChange:r.handleChange,onBlur:()=>r.handleBlur({target:{name:e}}),checked:typeof r.values[e]=="string"&&r.values[e].toLowerCase()===n.toLowerCase(),label:n},c))}),j=(e,a,r=!1)=>e.map(({name:i,typeInput:n,label:c,placeholder:l})=>t.jsx("div",{children:t.jsx(N,{formik:a,id:i.toLowerCase(),type:n,placeholder:l,label:c,onBlur:()=>a.handleBlur({target:{name:i}}),showError:()=>r(!0)})},i)),me=e=>{const a=parseFloat(e);return isNaN(a)?0:a},de=({currentStep:e,setCurrentStep:a,onError:r})=>{const[i,n]=y.useState(!1),c=q(),l=E(F),[x,s]=y.useState({name:"",email:"",password:"",goal:p.goal[0].toLowerCase(),gender:p.gender[0].toLowerCase(),age:"",weight:"",height:"",activity:p.activity[0].toLowerCase()}),g={initialValues:x,validationSchema:ae(e),onSubmit:async h=>{if(e===4){n(!0);const u=m.values.activity;h.activity=me(h.activity);try{await c(P(h)),h.activity=u,n(!1)}catch{r(l||"An unexpected error occurred.")}}else a(u=>u+1),s(u=>({...u,...h}))}};(e===2||e===3)&&(g.validateOnChange=!1,g.validateOnBlur=!1);const m=W(g);y.useEffect(()=>{l&&r(l)},[l,r]);const L=()=>{e>0&&a(h=>h-1)};return t.jsxs("form",{onSubmit:m.handleSubmit,children:[i&&t.jsx(D,{}),t.jsxs(K,{$hasBackButton:e>0,children:[e===0&&t.jsx(t.Fragment,{children:j(w.main,m)}),e===1&&t.jsx(t.Fragment,{children:S("goal",p.goal,m)}),e===2&&t.jsxs(t.Fragment,{children:[t.jsx(se,{children:"Gender"}),S("gender",p.gender,m),j(w.age,m)]}),e===3&&t.jsx(t.Fragment,{children:j(w.parameters,m)}),e===4&&t.jsx(t.Fragment,{children:S("activity",p.activity,m,!0)})]}),t.jsxs(te,{children:[t.jsx(re,{type:"submit",btnName:e===4?"Submit":"Next"}),e>0&&t.jsx(ie,{type:"button",onClick:L,children:"Back"})]})]})},M="/healthy-hub/assets/body_parameters_desk@1x-1c715572.png",ge="/healthy-hub/assets/body_parameters_desk@2x-28117c28.png",he="/healthy-hub/assets/body_parameters_tab@1x-c695adc6.png",be="/healthy-hub/assets/body_parameters_tab@2x-90001dc8.png",pe="/healthy-hub/assets/body_parameters_mob@1x-98e56b9f.png",ue="/healthy-hub/assets/body_parameters_mob@2x-0f8a4fd8.png",f={desk:{png:[`${M}`,`${ge}`]},tab:{png:[`${he}`,`${be}`]},mob:{png:[`${pe}`,`${ue}`]}},ye=M.replace("/healthy_hub/src/images/Illustrations/Welcome/","").split("_d")[0].split(".")[0].replace(/_/g," "),xe=o(f,"desk"),_e=o(f,"tab"),fe=o(f,"mob"),ke=`${f.desk.png[0]}`,$e=ye,B="/healthy-hub/assets/gender_and_age_desk@1x-20ef5e41.png",ve="/healthy-hub/assets/gender_and_age_desk@2x-45c6a53e.png",Ie="/healthy-hub/assets/gender_and_age_tab@1x-77482e77.png",we="/healthy-hub/assets/gender_and_age_tab@2x-10e03a0d.png",Se="/healthy-hub/assets/gender_and_age_mob@1x-8a050d10.png",je="/healthy-hub/assets/gender_and_age_mob@2x-bfdf5d0b.png",k={desk:{png:[`${B}`,`${ve}`]},tab:{png:[`${Ie}`,`${we}`]},mob:{png:[`${Se}`,`${je}`]}},Ae=B.replace("/healthy_hub/src/images/Illustrations/Welcome/","").split("_d")[0].split(".")[0].replace(/_/g," "),Me=o(k,"desk"),Be=o(k,"tab"),Ge=o(k,"mob"),Te=`${k.desk.png[0]}`,Le=Ae,G="/healthy-hub/assets/activity_desk@1x-3938b1bf.png",Ce="/healthy-hub/assets/activity_desk@2x-f0e9f5cb.png",Ne="/healthy-hub/assets/activity_tab@1x-b19b7244.png",qe="/healthy-hub/assets/activity_tab@2x-2d24ebb8.png",Ee="/healthy-hub/assets/activity_mob@1x-6e9825c8.png",Fe="/healthy-hub/assets/activity_mob@2x-8945770f.png",$={desk:{png:[`${G}`,`${Ce}`]},tab:{png:[`${Ne}`,`${qe}`]},mob:{png:[`${Ee}`,`${Fe}`]}},Pe=G.replace("/healthy_hub/src/images/Illustrations/Welcome/","").split("_d")[0].split(".")[0].replace(/_/g," "),We=o($,"desk"),De=o($,"tab"),Re=o($,"mob"),Ve=`${$.desk.png[0]}`,He=Pe,T="/healthy-hub/assets/summer_hiking_desk@1x-a71ef474.png",Ye="/healthy-hub/assets/summer_hiking_desk@2x-10ca5519.png",Ue="/healthy-hub/assets/summer_hiking_tab@1x-31b23b5f.png",ze="/healthy-hub/assets/summer_hiking_tab@2x-fa3fa793.png",Oe="/healthy-hub/assets/summer_hiking_mob@1x-91b8a54a.png",Qe="/healthy-hub/assets/summer_hiking_mob@2x-2eda95f6.png",v={desk:{png:[`${T}`,`${Ye}`]},tab:{png:[`${Ue}`,`${ze}`]},mob:{png:[`${Oe}`,`${Qe}`]}},Xe=T.replace("/healthy_hub/src/images/Illustrations/Welcome/","").split("_d")[0].split(".")[0].replace(/_/g," "),Ze=o(v,"desk"),Je=o(v,"tab"),Ke=o(v,"mob"),et=`${v.desk.png[0]}`,tt=Xe,st={0:{media:{srcDesk:o(_,"desk"),srcTab:o(_,"tab"),srcMob:o(_,"mob"),imgSrc:`${_.desk.png[0]}`,alt:R},info:{title:"Sign up",text:"You need to register to use the service"}},1:{media:{srcDesk:Ze,srcTab:Je,srcMob:Ke,imgSrc:et,alt:tt},info:{title:"Your goal",text:"Choose a goal so that we can help you effectively"}},2:{media:{srcDesk:Me,srcTab:Be,srcMob:Ge,imgSrc:Te,alt:Le},info:{title:"Select gender, Age",text:"Choose a goal so that we can help you effectively"}},3:{media:{srcDesk:xe,srcTab:_e,srcMob:fe,imgSrc:ke,alt:$e},info:{title:"Body parameters",text:"Enter your parameters for correct performance tracking"}},4:{media:{srcDesk:We,srcTab:De,srcMob:Re,imgSrc:Ve,alt:He},info:{title:"Your Activity",text:"To correctly calculate calorie and water intake"}}},ct=()=>{const{resetAuthError:e}=J(),[a,r]=y.useState(0),[i,n]=y.useState(null),c=g=>{r(g),n(null)},l=g=>{n(g)},x=a===0,s=st[a];return t.jsxs("div",{className:"container",children:[i&&i.type==="register"&&t.jsx(V,{children:i.message}),t.jsxs(H,{children:[t.jsx(Y,{children:t.jsxs("picture",{children:[s==null?void 0:s.media.srcDesk,s==null?void 0:s.media.srcTab,s==null?void 0:s.media.srcMob,t.jsx("img",{src:s==null?void 0:s.media.imgSrc,alt:s==null?void 0:s.media.alt})]})}),t.jsxs(U,{children:[t.jsx(z,{children:s==null?void 0:s.info.title}),t.jsx(O,{children:s==null?void 0:s.info.text}),t.jsx(Q,{$isSigninVisible:x,children:t.jsx(de,{onError:l,currentStep:a,setCurrentStep:c})}),x&&t.jsxs(X,{children:[t.jsx("p",{children:"Do you already have an account?"}),t.jsx(Z,{to:"/signin",onClick:e,children:"Sign in"})]})]})]})]})};export{ct as default};
